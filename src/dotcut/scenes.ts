...
// 调色板：水文蓝家族。前色 = 圆点 / 字符色；后色 = 背景。
// 全部走冷调 slate + accent，跟站点 token 系统保持一致。
// 6 套双色调保持"打孔可读"的对比度，但去掉了原版的黄/红/粉。
export const PALETTES: [string, string][] = [
  ['#0e7490', '#eef2f6'], // accent vs paper-100（最经典水文蓝 + 冷白）
  ['#17a3c5', '#0d1522'], // accent-bright on ink-50（暗色仪表卡）
  ['#43536b', '#fbfcfd'], // ink-400 on paper（最弱对比，沉稳）
  ['#0f172a', '#cbd5e1'], // ink-900 on ink-300（黑底浅网格，反转）
  ['#1e293b', '#dde4ee'], // ink-800 on ink-100
  ['#0e7490', '#1d2939'], // accent on ink-200（暗色高饱和）
]
